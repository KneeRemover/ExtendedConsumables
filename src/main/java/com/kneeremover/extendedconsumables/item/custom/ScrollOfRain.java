...
public class ScrollOfRain extends ExtendedScroll { // The friends we made along the way
	public ScrollOfRain() {
		super(true, "scroll_rain");
	}
	...
	public InteractionResultHolder<ItemStack> use(Level pLevel, @NotNull Player pPlayer, @NotNull InteractionHand pHand) {
		...
		if (pLevel instanceof ServerLevel slevel) {
			slevel.setWeatherParameters(0, 20 * 60 * 20, true, false);
