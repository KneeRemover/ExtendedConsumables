...
public class RadiantEffect extends MobEffect {
	public RadiantEffect(MobEffectCategory pCategory, RegistryObject<MobEffect> targetEffect, RegistryObject<SimpleParticleType> particleType, int pColor, int amplifier, boolean isPositive) {
	...
	public RadiantEffect(MobEffectCategory pCategory, MobEffect targetEffect, RegistryObject<SimpleParticleType> particleType, int pColor, int amplifier, boolean isPositive) {
		super(pCategory, pColor);
		this.isPositive = isPositive;
		this.amplifier = amplifier;
